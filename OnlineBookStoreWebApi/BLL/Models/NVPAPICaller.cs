...
namespace BLL.Models
{
    public class NVPAPICaller
    {
        ...
        public string APIUsername = "sb-kka3c3559214_api1.business.example.com";
        public string APIPassword = "6Y3QF8FSTXQ6NKB2";
        private string APISignature = "AvGCpYM8k-0VrhtnLRrD2wSFZAQZAHcqfLpc5WzOW4liuC43o7zSb4fJ";
        ...
        public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
        {
            ...
            encoder["BRANDNAME"] = "Online Book Store";
            encoder["PAYMENTREQUEST_0_AMT"] = amt;
            encoder["PAYMENTREQUEST_0_ITEMAMT"] = amt;
            encoder["PAYMENTREQUEST_0_PAYMENTACTION"] = amt;
            encoder["PAYMENTREQUEST_0_CURRENCYCODE"] = amt;
    ...
    public sealed class NVPCodec : NameValueCollection
    {
        ...
        public void Decode(string nvpstring)
        {
            ...
            {
                string[] token = nvp.Split(EQUALS_CHAR_ARRAY);
                if (token.Length >= 2)
                {
                    string name = HttpUtility.UrlDecode(token[0]);
                    string value = HttpUtility.UrlDecode(token[1]);
                    Add(name, value);
                }
            }
        }
        ...
        public static string GetArrayName(int index, string name)
        {
            if (index<0)
            {
